...
b11 = Book.create(title: "Gunslinger", author: "Steven King", description: "A badass stuck in time.", publisher: "Scribner", weeks_on_list: 120, rank_this_week: 90)

b12 = Book.create(title: "Dune", author: "Frank Herbert", description: "Torture on a new world.", publisher: "Chilton Books", weeks_on_list: 10, rank_this_week: 89)
...
Review.create(comment: "really good", author: "Mee", book_id: b11.id)
Review.create(comment: "pretty good", author: "me2", book_id: b12.id)
